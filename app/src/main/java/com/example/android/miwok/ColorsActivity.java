...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("mustard yellow", "chiwitta", R.raw.color_mustard_yellow, R.drawable.color_mustard_yellow));

        WordAdapter itemAdapter = new WordAdapter(this, R.layout.list_item, words, R.color.category_colors);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (audioFocusGrant == AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(ColorsActivity.this, word.getmVoiceResouorceId());
